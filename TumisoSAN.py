...
jalan("\033[1;96m   ┈┈┈WE ALL CAN STOP CORONA  🛐 ")
...
def login():
	...
	try:
		...
		print "\033[1;95m••••••••••••••••••••••••••••••••••••••••••\033[1;96mRSA.ART033[1;95m♡─────•◈•───♡"
		print('	   \033[1;94m♡\x1b[1;91m■■■■■■LOGIN WITH FACEBOOK ACCOUNT■■■■■■\x1b[1;94m♡' )
		print('	' )
...
def pilih_super():
	...
	print "\033[1;95m••••••••••••••••••••••••••••••••\033[1;96mRSA ART\033[1;95m♡──────•◈•────♡"
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•••••••••••\033[1;96mRSA.CREATIONS\033[1;95m••••••••••••
